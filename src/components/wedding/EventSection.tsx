    ...
    return (
        <section id="acara" className="relative overflow-hidden bg-[#EDE4D6] px-6 py-24 text-[#32352F]">
            ...
            <div className="relative mx-auto max-w-lg text-center">
                ...
                <div className="relative mt-14 overflow-hidden rounded-[2.25rem] border border-[#B49A72]/20 bg-[#F6F0E6] px-6 py-9 shadow-[0_18px_50px_rgba(72,83,64,0.07)] sm:px-8 sm:py-10">
                    {/* subtle ornament */}
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-4 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[#846B54]">
                            Sabtu
                        </p>

                        <h3 className="mt-1 font-serif text-3xl text-[#485340] sm:text-4xl">
                            26 Desember 2026
                        </h3>
                        ...
                        <div className="grid grid-cols-2 divide-x divide-[#B49A72]/20">
                            <div className="px-2 sm:px-5">
                                ...
                                <p className="mt-3 font-serif text-[1.9rem] leading-none text-[#485340] sm:text-4xl">
                                    {wedding.akad.time}
                                </p>
                            </div>
